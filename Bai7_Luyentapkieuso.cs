...
namespace CSharpNumberExercises
{
    class Bai7_Luyentapkieuso
    {
        static void Main(string[] args)
        {
            ...
            while (running)
            {
                Console.WriteLine("a.Tính tổng 2 số nguyên");
                Console.WriteLine("b.Tính diện tích, chu vi hình chữ nhật(2byte)");
                Console.WriteLine("c.Kiểm tra số chẵn, lẻ");
                Console.WriteLine("d.tính tổng số nguyên có dấu");
                Console.WriteLine("e. Tính tổng các số từ 1-n");
                Console.WriteLine("g.Tính diện tích, chu vi hình chữ nhật(8 byte) ");
                Console.WriteLine("h. Tìm số lớn nhất trong 3 số");
                Console.WriteLine("k. Tính giai thừa");
                Console.WriteLine("l. Kiểm tra số nguyên tố");
                Console.WriteLine("m. Kiểm tra số hoàn hảo");
                Console.WriteLine("Chọn bài tập (a-m) hoặc 't' để thoát:");
